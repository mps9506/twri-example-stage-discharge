...
`r paste0("$Q=", coefficients(rc1_model)[["K"]], "(H-", coefficients(rc1_model)[["H_0"]], ")^", coefficients(rc1_model)[["Z"]], "$")`


The final equation for 2006-2011:

`r paste0("$Q=", coefficients(rc2_model)[["K"]], "(H-", coefficients(rc2_model)[["H_0"]], ")^", coefficients(rc2_model)[["Z"]], "$")`
